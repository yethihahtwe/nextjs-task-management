    ...
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl text-center mx-auto",
                ...
                Collaborate, manage projects, and reach new productivity peaks. From high risese to the home office, the way your team works is unique - accomplish it all with Taskify.
            </div>
